...
public interface InnerInterceptor {
     ...
     */
    default <T> boolean willDoQuery(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler<T> resultHandler, BoundSql boundSql) throws SQLException {
        return true;
    }
     ...
     * @throws SQLException SQLException
     */
    default <T> void beforeQuery(Executor executor, MappedStatement ms, Object parameter, RowBounds rowBounds, ResultHandler<T> resultHandler, BoundSql boundSql) throws SQLException {
        // do nothing
    }
