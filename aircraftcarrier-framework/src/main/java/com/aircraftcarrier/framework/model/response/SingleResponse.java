...
public class SingleResponse<T> extends Response {
    ...
    public static <T> SingleResponse<T> error() {
        return new SingleResponse<>(ErrorCode.INTERNAL_SERVER_ERROR, MessageUtils.getMessage(ErrorCode.INTERNAL_SERVER_ERROR));
    }

    public static <T> SingleResponse<T> error(int code) {
        return new SingleResponse<>(code, MessageUtils.getMessage(code));
    }
