...
public class HttpException extends Exception {
    ...
    public HttpException(int code, Map<String, List<String>> responseHeaders, String responseBody) {
    ...
    public HttpException(int code, String message, Map<String, List<String>> responseHeaders, String responseBody) {
        this(code, message);
        this.responseHeaders = responseHeaders;
        this.responseBody = responseBody;
    }
