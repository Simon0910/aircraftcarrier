package com.aircraftcarrier.framework.emoji;
...
public class EmojiTest {
    ...
    public void test() {
        ...
        System.out.println(EmojiUtil.removeAllEmojis(s));
        System.out.println(EmojiUtil.removeAllEmojis(ss));

        List<String> list = EmojiUtil.extractEmojis(s);
        List<String> list2 = EmojiUtil.extractEmojis(ss);
        Assert.assertFalse("error", list.isEmpty());
        Assert.assertEquals("error", list.size(), list2.size());

        Assert.assertFalse("contains emoji", EmojiUtil.containsEmoji(EmojiUtil.removeAllEmojis(s)));
        Assert.assertFalse("contains emoji", EmojiUtil.containsEmoji(EmojiUtil.removeAllEmojis(ss)));
