 ...
 * the License.
 */
package com.aircraftcarrier.generator.config.po;
...
import com.aircraftcarrier.generator.config.builder.Entity;
...
public class TableInfo {
     ...
     * 表字段
     */
    private final List<TableField> allFields = new ArrayList<>();
    /**
     * 表字段
     */
    ...
    public String getAllFieldNames() {
        //TODO 感觉这个也啥必要,不打算公开set方法了
        if (StringUtils.isBlank(allFieldNames)) {
            this.allFieldNames = this.allFields.stream().map(TableField::getColumnName).collect(Collectors.joining(", "));
        }
    ...
    public void processTable() {
        ...
        this.setOriginEntityName(entityName);
    ...
    public TableInfo setOriginEntityName(@NotNull String originEntityName) {
