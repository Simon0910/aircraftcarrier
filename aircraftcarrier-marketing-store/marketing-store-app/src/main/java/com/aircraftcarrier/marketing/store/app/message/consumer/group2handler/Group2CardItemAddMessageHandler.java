...
@Slf4j
@Component
public class Group2CardItemAddMessageHandler extends AbstractRocketMQGroupTagHandler<CartItemEvent> {
    ...
    public void doHandle(CartItemEvent cartItemEvent) throws Exception {
        log.info("group 2 cart_item_add " + JSON.toJSONString(cartItemEvent));
        // Thread.sleep(1000);
        // throw new NeedRetryException("haha");
        log.info("group 2 cart_item_add end");
    }
