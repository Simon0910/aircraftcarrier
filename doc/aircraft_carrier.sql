...
CREATE TABLE IF NOT EXISTS `product_details` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `weight` int(32) NOT NULL COMMENT '宽度',
  `exist` tinyint(1) NOT NULL COMMENT '是否存在',
  ...
  `data_type` tinyint(1) NOT NULL COMMENT '类型',
  `birthday` datetime NOT NULL COMMENT '生日',
  `amount`      decimal(8, 2)                                      NOT NULL COMMENT '金额',
  `marketFlag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '是否超市商品',
